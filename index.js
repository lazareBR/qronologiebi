...
const something = "gelaa axali gela jumberi";
...
const topics = [
  ...
  [
    ...
    [
      "შეიქმნა ''ყულის ჯარი'' ",
      "შაჰ-აბასმა ერევნის ციხე აიღო",
      "ბრძოლა ურმიის ტბასთან ",
      "ძეგამის ტრაგედია",
      "ხალხთა გადასახლება ქართლ-კახეთიდან",
      "ქეთევან დედოფლის წამება",
      "მარტყოფის ბრძოლა",
      "მარაბდის ბრძოლა",
      "ბაზალეთის ბრძოლა",
      "როსტომ-ხანის ''რეფორმები''",
      "ზოჰაბის ზავი",
    ],
  ],
  //არაბები
  ...
  [
    ...
    [
      "შაჰ-თამაზის ლაშქრობები საქართველოში",
      "მურჯახეთის ბრძოლა",
      "სოხოისთას ბრძოლა",
      "ამასიის ზავი",
      "გარინსის ბრძოლა",
      "სიმონი ტყვედ ჩავარდა(ალამუთი)",
      "ბრძოლა ჩილდირის ტბასთან",
      "შეიქმნა ახალციხის საფაშო",
      "სიმონი ტყვედ ჩავარდა(იედიყული)",
    ],
    ["შეიქმნა მცველთა ჯარი", ",,სწავლულ კაცთა კომისია''", "დაარსდა სტამბა"],
    [
      "განჯის ხანი დაამარცხეს ერეკლე II-მ და თეიმურაზ II",
      "ყირგულასთან დაამარცხეს აზერბაიჯანის პატრონი აზატ ხანი",
      "ერეკლე და თეიმურაზი დამარცხდნენ 2ჯერ  აჯი ჩალაბთან",
      "ნურსალ ბეგის მჭადი ჯვართან ბრძოლა",
      "ნურსალ ბეგის ყვარელთან ბრძოლა ",
      "თეიმურაზ II გზაში გარდაიცვალა(1762წ)",
      "ტოტლებენის შემოსვლა",
      "ასპინძის ბრძოლა",
      "ქუჩუკ კაინარჯის ზავი",
    ...
    [
      "საქართველოს მოამბე",
      "გაზეთი დროება",
      "სათავადაზნაურო საადგილმამულო ბანკი",
      "გაზეთი ივერია",
      "წერა-კითხვის გამავრცელებელი საზოგადოება",
      "გაზეთი კვალი",
      "ნიკო ნიკოლაძე ფოთის თავად დანიშნეს",
    ],
    [
      "შეიქმნა ,,ოზაკომი''",
      "ავტოკეფალიის აღდგენა",
      "დაარსდა ამიერ კავკასიის კომისარიატი",
      "სახელმწიფო უნივერსიტეტის გახსნა",
      "ბრესტის ზავი",
      "საქართველოს დამოუკიდებლობის გამოცხადება",
      "საქართველოს პირველი კონსტიტუცია",
    ],
    [
      "ხელშეკრულება აფხაზეთსა და ქართულ მთავრობას შორის",
      "სომხეთ-საქართველოს ომი",
      "ოსების აჯანყება",
      "7 მაისის ხელშეკრულება",
      "თბილისის დაკავება ბოლშევიკების მიერ",
      "სვანეთის აჯანყება",
      "დამოუკიდებლობის კომიტეტი/აგვისტოს აჯანყება",
    ],
  ],
  //სელჩუკები
  [],
  ...
  [
    [
      "საფრანგეთის ტახტზე ადის ფილიპე VI ვალუა",
      "სლეის ბრძოლა",
      "კრესის ბრძოლა",
      "ქალაქ კალეს აღება",
      "პუატიეს ბრძოლა",
  ...
  [
    [
      ...
      "პილნიცის დეკლარაცია",
      "სანკიულოტებმა მეფის სასახლე აიღეს",
      "ვალმის ბრძოლა",
      "ლუი XVI-ის სიკვდილით დასჯა",
      ',,ვანტოზის დეკრეტები"',
      "რობერსპიერის სიკვდილით დასჯა",
    ],
    [
      "18 ბრიუმორის გადატრიალება",
      "ტრაფალგარის ბრძოლა",
      "აუსტერლიცის ბრძოლა",
      "ტილზიტის ზავი",
      ...
      "ბოროდინოს ბრძოლა",
      "ლაიფციგის ბრძოლა",
      "ნაპოლეონი გადაასახლეს კუნძულ ელბაზე",
      "ვატერლოუს ბრძოლა",
      "ვენის კონგრესი",
    ],
    ...
    [],
    [
      "პრუსია & ავსტრია ომს უცხადებენ დანიას",
      "სადოვას ბრძოლა",
      "ესპანეთის რევოლუცია",
      "სედანის ბრძოლა",
      "საფრანგეთის II იმპერია გადაკეთდა III რესპუბლიკად",
      "ფრანკფურტის ზავი",
      "ვერსალის შეხვედრა",
    ],
    [
      "სიცილიის რევოლუცია",
      "რომი რესპუბლიკად გამოცხადდა",
      "კუსტოზას ბრძოლა",
      "მოკავშირეებმა ლომბარდიიდან გაყარეს ავსტრიელები",
      "სიცილიის აჯანყება",
      "სამხრეთ იტალიის შემოერთება",
      "ვენეციის ოლქი იტალიას შეურეთდა",
      "რომის ოლქის შეერთება",
    ],
  ],
  //XX საუკუნე
  [
    [
      ...
      "გერმანია შეიჭრა ბელგიაში",
      "მარნის ბრძოლა",
      "იაპონიის ომში ჩაბმა",
      "სარიყამიშის ბრძოლა",
      "იპრის ბრძოლა",
      "იტალიის ომში ჩაბმა",
      "შეტევა ვერდენის ციხეზე",
      "სომას ბრძოლა",
      "ოქტრომბრის რევოლუცია",
      "აშშ-ს ომში ჩაბმა",
      "ბრესტის ზავი",
      "გერმანიის რევოლუცია",
    ],
    [
      "გერმანიამ და სსრკ-მ გაიყო პოლონეთი",
      "სსრკ-ს შეჭრა ფინეთში",
      "გერმანიამ დაიპყრო დანია,ნორვეგია და ბელგია",
      "სსრკ-მ დაიპყრო ბალტიის ქვეყნები",
      "კომპეინის ზავი",
      "ოპერაცია ზღვის ლომი",

      "ჰიტლერის მარცხი მოსკოვთან",
      "პერლ-ჰარბორი",
      "ელ-ალამეინის ბრძოლა",
      "კურსკის სატანკო ბრძოლა",
      "დაემხო მუსოლინის მთავრობა",
